...
public class PruebaTreeSet {
	...
	public static void main(String[] args) {
		...
		//ComparatorArticulos compara_art = new ComparatorArticulos();
		TreeSet<Articulo>ordenaArticulo2 = new TreeSet<Articulo>(new Comparator<Articulo>() {

			@Override
			public int compare(Articulo o1, Articulo o2) {
				// TODO Auto-generated method stub
				String desc1 = o1.getDescripccion();
				String desc2 = o2.getDescripccion();
...
//
/*
 * class ComparatorArticulos implements Comparator<Articulo>{
 * 
 * @Override public int compare(Articulo o1, Articulo o2) { // TODO
 * Auto-generated method stub String desc1 = o1.getDescripccion(); String desc2
 * = o2.getDescripccion(); return desc1.compareTo(desc2); }
 * 
 * }//
 */